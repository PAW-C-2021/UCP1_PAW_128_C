...
namespace Pendaftaran.Controllers
{
    public class PetugasController : Controller
    {
        ...
        public PetugasController(PendaftaranContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPetugas,NamaPetugas,JenisKelamin")] Petugas petugas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPetugas,NamaPetugas,JenisKelamin")] Petugas petugas)
        {
